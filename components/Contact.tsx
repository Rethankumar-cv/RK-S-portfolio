          ...
          <div className="flex items-center gap-3 mb-8 sm:mb-10">
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/[0.04] hover:bg-white/[0.09] active:bg-white/[0.09] border border-white/[0.07] hover:border-white/[0.14] transition-all duration-200 text-neutral-400 hover:text-neutral-200 text-[13px] font-semibold min-h-[44px] sm:min-h-[46px]"
              >
                {icon}
                {label}
              </motion.a>
              ...
              <motion.button
                ...
                className={
                  ...
                  (formState === "sent"
                    ...
                    : formState === "sending"
                    ? "bg-white/[0.03] border-white/[0.06] text-neutral-500 cursor-not-allowed"
                    : "bg-white/[0.05] hover:bg-white/[0.09] border-white/[0.08] text-neutral-400 hover:text-neutral-200")
                }
              >
