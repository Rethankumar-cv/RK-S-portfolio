    ...
    <div className="w-full px-2 sm:px-0">
      <div className="text-center mb-16 sm:mb-24 relative">
        ...
        >
          ...
          <h3 className="text-[clamp(2.5rem,5vw,4rem)] font-bold text-white tracking-tight leading-loose text-center">
            My <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-300 to-neutral-600">Process</span>
          </h3>
          <p className="mt-1 sm:mt-2 text-[15px] sm:text-base text-neutral-400 max-w-2xl mx-auto font-light leading-relaxed px-4 text-center">
          ...
          return (
            ...
            >
              ...
              <div className={`w-full md:w-1/2 flex justify-start ${isEven ? "md:justify-end md:pr-12" : "md:order-last md:pl-12"} pl-14 sm:pl-16 md:pl-0`}>
                <div className="glass p-5 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl border border-white/5 relative group md:hover:border-white/10 md:hover:bg-white/[0.04] transition-all w-full max-w-md shadow-lg">
                   ...
                   <h4 className="text-lg sm:text-xl font-bold text-white tracking-wide mb-2 sm:mb-3 flex items-center gap-2 relative z-10 md:group-hover:text-indigo-200 transition-colors">
                     {step.title}
                   </h4>
                   <p className="text-neutral-400 font-light leading-relaxed text-[13px] sm:text-sm relative z-10">
                     {step.description}
                   </p>
                </div>
              </div>
