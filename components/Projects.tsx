  ...
  return (
    <motion.div variants={itemVariants} style={{ perspective: 1200 }} className="w-full h-full">
      <motion.div
        ...
        className={cn(
          "relative w-full h-full bg-white/[0.02] rounded-2xl sm:rounded-3xl p-5 sm:p-7 border border-white/[0.05] overflow-hidden flex flex-col gap-5 transition-all duration-300 group",
          project.border,
